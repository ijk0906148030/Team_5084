...
_C.MODEL.HEADS.EMBEDDING_DIM = 512
...
_C.MODEL.LOSSES.COSFACE.MARGIN = 0.35
_C.MODEL.LOSSES.COSFACE.GAMMA = 64
_C.MODEL.LOSSES.COSFACE.SCALE = 1.0

# ArcFace Loss options
_C.MODEL.LOSSES.ARCFACE = CN()
_C.MODEL.LOSSES.ARCFACE.SCALE = 64.0  
_C.MODEL.LOSSES.ARCFACE.MARGIN = 0.5  

# Combined Margin Loss options
_C.MODEL.LOSSES.COMBINED_MARGIN_LOSS = CN()
_C.MODEL.LOSSES.COMBINED_MARGIN_LOSS.SCALE = 64.0  
_C.MODEL.LOSSES.COMBINED_MARGIN_LOSS.M1 = 1.0     
_C.MODEL.LOSSES.COMBINED_MARGIN_LOSS.M2 = 0.5      
_C.MODEL.LOSSES.COMBINED_MARGIN_LOSS.M3 = 0.0      
