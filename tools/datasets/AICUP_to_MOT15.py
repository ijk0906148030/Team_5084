...
def arg_parse():
    ...
    parser.add_argument('--AICUP_dir', type=str, default='trainv2', help='your AICUP dataset path')
    parser.add_argument('--MOT15_dir', type=str, default='AICUP_MOT15', help='converted dataset directory')
